...
export default class AddSales extends React.Component {
    ...
    onDateChange(date) {
      ...
      selectSL(i){
        this.pickerf.toggle();
        this.setState({shows:true,SLIndex:i,});
      }
          ...
          this.state.MAPData.forEach((data,i)=>{
           ...
           ISTJ = false;
            ...
            if(that.state.DateTimes[i][0] == ''){
              Toast.showShortBottom("请选择地址"+numsIndex+"交货日期")
        			return false;
            ...
            if(that.state.MAPSCROLL[i].length == 0){
              Toast.showShortBottom("请添加产品")
              return false;
            }else{
            that.state.MAPSCROLL[i].forEach((info,j)=>{
              ISTJ = false;
              if(this.state.SLName[i][j] == '请选择税率'){
                Toast.showShortBottom("请选择税率");
                ISSENT=true;
                return false;
              }else if(this.state.BXDY[i][j] == ''){
                Toast.showShortBottom('请输入'+this.state.BXNAME+'值');
                ISSENT=true;
                return false;
              }else{
              ...
              if(i == this.state.MAPData.length-1 && j == that.state.MAPSCROLL[this.state.MAPData.length-1].length-1 && !ISSENT){
                console.log(arr);
                that.FecthData(foreign_currency,mapobj,return_money_info,arr,sum);
      ...
      FecthData(foreign_currency,mapobj,return_money_info,arr,sum){
        var that = this;
        var obs = {
              'noshenhe':0,
      ...
      selectDW(j,data){
        var arr = [];
        var that = this;
        this.setState({DW_DATA:data,})
        data.forEach((info,i)=>{
          arr.push(info.unitname);
          that.setState({DWARR:arr,shows:true,SLIndex:j,})
          this.pickerDW.toggle();
        })
           ...
           return (
                ...
                <View style={styles.card}>
                 ...
                 <View style={{flex:1,flexDirection:'row',backgroundColor:'#fff'}}>
                    ...
                    {this.state.Scrollshows ? <ScrollView  automaticallyAdjustContentInsets={false}  style={{flex:1,backgroundColor:'#ececec',flexDirection:'column',}}>
                       ...
                       <View style={{flexDirection:'row',height:50,backgroundColor:'#fff',alignItems:'center',justifyContent:'center',paddingLeft:10,marginTop:1}}>
                          ...
                          <TouchableOpacity onPress={this.GLDD.bind(this)} activeOpacity={0.8} style={{flex:1,marginLeft:15,flexDirection:'row',alignItems:'center',paddingRight:10,}}>
                            <View style={{flex:1,}}>
                                <Text allowFontScaling={false} adjustsFontSizeToFit={false} style={{fontSize:17,textAlign:'right',paddingRight:15, alignItems:'center'}}>
                       ...
                       {this.state.FWDD ? <View style={{flexDirection:'row',height:50,backgroundColor:'#fff',alignItems:'center',justifyContent:'center',paddingLeft:10,marginTop:1}}>
                          ...
                          <TouchableOpacity onPress={this._datetime.bind(this)} activeOpacity={0.8} style={{flex:1,marginLeft:15,flexDirection:'row',alignItems:'center',paddingRight:10,}}>
                            <View style={{flex:1,}}>
                                <Text allowFontScaling={false} adjustsFontSizeToFit={false} style={{fontSize:14,textAlign:'right',paddingRight:15, alignItems:'center'}}>
                                    {this.state.result}
                                </Text>
                       ...
                       {this.state.FWDD ? <View style={{flexDirection:'row',height:50,backgroundColor:'#fff',alignItems:'center',justifyContent:'center',paddingLeft:10,marginTop:1}}>
                          ...
                          <TouchableOpacity onPress={this._datetime1.bind(this)} activeOpacity={0.8} style={{flex:1,marginLeft:15,flexDirection:'row',alignItems:'center',paddingRight:10,}}>
                            <View style={{flex:1,}}>
                                <Text allowFontScaling={false} adjustsFontSizeToFit={false} style={{fontSize:14,textAlign:'right',paddingRight:15, alignItems:'center'}}>
                                    {this.state.result1}
                                </Text>
                    ...
                    {this.state.MAPMAIN ? this.state.MAPData.map((data,i)=>{
                      return this.state.scrollData[i] ? <View key={i} style={{flex:1}}><ScrollView stickyHeaderIndices={[0]} automaticallyAdjustContentInsets={false}  style={{flex:1,backgroundColor:'#ececec',flexDirection:'column',}}>
                          <View style={{flexDirection:'row', paddingTop:16,paddingBottom:16,backgroundColor:'#fff',alignItems:'center',justifyContent:'center',paddingLeft:10,borderBottomWidth:1,borderColor:'#ececec'}}>
                             <Text allowFontScaling={false} adjustsFontSizeToFit={false} style={{color:'#333',fontSize:14}}>
                                 地址
                             </Text>
                             <View style={{flex:1,marginLeft:15,flexDirection:'row',alignItems:'center',paddingRight:10,}}>
                      ...
                      onPickerCancel={()=>{this.setState({shows:false});}}
                        ...
                        if(pickedValue == '赊销'){
                          ...
                          this.setState({isZQ:false})
          				    ...
          				    />
                      <Picker
            						ref={picker => this.pickerc = picker}
            						style={{height: 250,backgroundColor:'#fff',}}
            						pickerToolBarStyle={{height:45,}}
            						pickerBtnStyle ={{fontSize:16,color:'#000',}}
            						showDuration={600}
            						pickerBtnText='确定'
            						pickerCancelBtnText='取消'
            						selectedValue={this.state.DataName[0]}
                          ...
                          this.state.shData.map((data,i)=>{
                            if(data.name == pickedValue){
                              this.setState({nameID:data.uid});
            				    ...
            				    />
                        <Picker
              						ref={picker => this.pickerd = picker}
              						style={{height: 250,backgroundColor:'#fff',}}
              						pickerToolBarStyle={{height:45,}}
              						pickerBtnStyle ={{fontSize:16,color:'#000',}}
              						showDuration={600}
              						pickerBtnText='确定'
              						pickerCancelBtnText='取消'
              						selectedValue={this.state.HLData[0]}
                            ...
                            this.state.MainData.cws.map((data,i)=>{
                              if(data.name == pickedValue){
                                ...
                                this.setState({HLID:data.id});
              				    ...
              				    />
                          <Picker
                						ref={picker => this.pickere = picker}
                						style={{height: 250,backgroundColor:'#fff',}}
                						pickerToolBarStyle={{height:45,}}
                						pickerBtnStyle ={{fontSize:16,color:'#000',}}
                						showDuration={600}
                            ...
                            onPickerCancel={()=>{this.setState({shows:false});}}
                						onPickerDone={(pickedValue) => {
                              BXQValuesName[this.state.INDEXMAP][this.state.BXQIndex] = pickedValue;
                              if(pickedValue == '默认'){
                                BXQValuesData[this.state.INDEXMAP][this.state.BXQIndex]=0;
                                BXQshows[this.state.BXQIndex] = false;
                              }else if(pickedValue == '天'){
                                BXQValuesData[this.state.INDEXMAP][this.state.BXQIndex]=1;
                                BXQshows[this.state.BXQIndex] = true;
                              }else if(pickedValue == '月'){
                                BXQValuesData[this.state.INDEXMAP][this.state.BXQIndex]=2;
                                BXQshows[this.state.BXQIndex] = true;
                              }else if(pickedValue == '年'){
                                BXQValuesData[this.state.INDEXMAP][this.state.BXQIndex]=3;
                                BXQshows[this.state.BXQIndex] = true;
                              }else{
                                BXQshows[this.state.BXQIndex] = true;
                              }
                              this.setState({BXQData:BXQValuesName,shows:false,BXQshow:BXQshows});
                				    ...
                				    />
                            <Picker
                  						ref={picker => this.pickerf = picker}
                  						style={{height: 250,backgroundColor:'#fff',}}
                  						pickerToolBarStyle={{height:45,}}
                  						pickerBtnStyle ={{fontSize:16,color:'#000',}}
                  						showDuration={600}
                  						pickerBtnText='确定'
                  						pickerCancelBtnText='取消'
                  						selectedValue={this.state.SLData[0]}
                  						pickerData={this.state.SLData}
                              onPickerCancel={()=>{this.setState({shows:false});}}
                  						onPickerDone={(pickedValue) => {
                                SLDATAMAIN[this.state.INDEXMAP][this.state.SLIndex]=pickedValue;
                                this.setState({SLName:SLDATAMAIN,shows:false,});
                                this.state.SLDATAS.map((data,i)=>{
                                  if(data.taxRate+' '+data.state == pickedValue){
                                    SLSDATA[this.state.INDEXMAP][this.state.SLIndex]=data.taxRate;
                                    SLIDData[this.state.INDEXMAP][this.state.SLIndex]=data.id;
                                    this.setState({SLID:SLIDData,SLSDATA})
                  				    ...
                  				    />
                              <Picker
                    						ref={picker => this.pickerDW = picker}
                    						style={{height: 250,backgroundColor:'#fff',}}
                    						pickerToolBarStyle={{height:45,}}
                    						pickerBtnStyle ={{fontSize:16,color:'#000',}}
                    						showDuration={600}
                    						pickerBtnText='确定'
                    						pickerCancelBtnText='取消'
                    						selectedValue={this.state.DWARR[0]}
                    						pickerData={this.state.DWARR}
                                onPickerCancel={()=>{this.setState({shows:false});}}
                    						onPickerDone={(pickedValue) => {
                       ...
                       <Modal
                        ...
                        {this.state.shows ? <View style={{width:Dimensions.get('window').width,height:Dimensions.get('window').height,backgroundColor:'rgba(107, 107, 107, 0.43)',position:'absolute',top:0,left:0}}></View> : null}
                        <Picker
                          ref={picker => this.pickerHK = picker}
                          style={{height: 250,backgroundColor:'#fff',}}
                          pickerToolBarStyle={{height:45,}}
                          pickerBtnStyle ={{fontSize:16,color:'#000',}}
                          showDuration={600}
                          pickerBtnText='确定'
                          pickerCancelBtnText='取消'
                          selectedValue={this.state.HKDATA[0]}
