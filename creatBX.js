                ...
                <View style={{flex:1,flexDirection:'column',}}>
                   ...
                   <Modal
                      ...
                      <Picker
                       ...
                       selectedValue={this.state.cateNames[0]}
                       pickerData={this.state.cateNames}
                       onPickerCancel={()=>{this.setState({showsk:false});}}
                       ...
                       <Picker
                        ...
                        onPickerDone={(pickedValue) => {
                          ...
                          if(pickedValue == '报销项目'){
                            this.setState({bxObjShow:true,khShow:false,xmPShow:false,shPShow:false,bxObj:'请选择',default1:0})
                          }else if(pickedValue == '客户'){
                            this.setState({bxObjShow:false,khShow:true,xmPShow:false,shPShow:false,bxObj:'请选择',default1:1})
                          }else if(pickedValue == '项目管理'){
                            this.setState({bxObjShow:false,khShow:false,xmPShow:true,shPShow:false,bxObj:'请选择',default1:2})
                          }else if(pickedValue == '售后管理'){
                            this.setState({bxObjShow:false,khShow:false,xmPShow:false,shPShow:true,bxObj:'请选择',default1:3})
                          }
                        }}
                        />
                        <Picker
                         ...
                         pickerBtnText='确定'
                         pickerCancelBtnText='取消'
                         selectedValue={this.state.lyDatas[0]}
                  ...
                  {this.state.statua ? <View style={{padding:10,width:200,backgroundColor:'rgba(23, 22, 22, 0.7)',justifyContent:'flex-start',alignItems:'center',position:'absolute',top:(Dimensions.get('window').height-150)/2,left:(Dimensions.get('window').width-200)/2,}}>
                       ...
                       <Picker
                        ...
                        pickerBtnText='确定'
                        pickerCancelBtnText='取消'
                        selectedValue={this.state.nameData[0]}
