  ...
  _startTime(){
    ...
    _submit(){
      ...
      if(this.state.result == '请选择(必填)'){
        ...
        Toast.showShortBottom("请填写出差地点")
  			return false;
      }else if(this.trim(this.state.textaera) == ''){
        Toast.showShortBottom("请填写出差原因")
  			return false;
      }else{
		           ...
		           <View style={styles.card}>
                    ...
                    <TouchableOpacity onPress={this._submit.bind(this)}>
                       <View style={{justifyContent:'flex-end',flexDirection:'row',alignItems:'center',}}>
    					...
    					<ScrollView keyboardDismissMode={'interactive'} style={{flexDirection:'column',backgroundColor:'#ececec',flex:1}}>
                ...
                <View style={{flexDirection:'row',backgroundColor:'#fff',alignItems:'flex-start',justifyContent:'center',borderTopWidth:1,borderBottomWidth:1,borderColor:'#dcdcdc',marginTop:15,paddingLeft:10,}}>
                   ...
                   <View style={{flex:1,marginLeft:15,}}>
                     <TextInput
                       ...
                       numberOfLines={2}
                       placeholderTextColor={'#ccc'}
                       style={{ color:'#666',fontSize:14,textAlignVertical:'top',paddingTop:0,height:50}}
                       placeholder='出差地点(必填)'
                       underlineColorAndroid={'transparent'}
                     />
                   </View>
